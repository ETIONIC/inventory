...
##### Laravel 4:
    ...
    php artisan migrate:publish --package="etionic/laravel-inventory"
...
However, the exception `Etionic\Inventory\Exceptions\StockIsSufficientException` has been removed.
...
The new trait added is named `Etionic\Inventory\Traits\AssemblyTrait`. This trait will need to be inserted into
