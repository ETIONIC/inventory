...
The exception `Etionic\Inventory\Exceptions\InvalidPartException` is thrown when you try to add a part to an assembly
...
As such when managing stock quantities, you will receive an `Etionic\Inventory\Exceptions\InvalidQuantityException` if
